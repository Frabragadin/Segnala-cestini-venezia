// ═══════════════════════════════════════════════════════════════
//  SegnalaOra — Google Apps Script (TEMPLATE)
...
//
//  Sostituisci tutti i valori marcati con ← prima di pubblicare.
// ═══════════════════════════════════════════════════════════════

// ─── Configurazione Google Sheet ─────────────────────────────
// ID del tuo Google Sheet: apri il foglio e copia la stringa
// nella URL tra /spreadsheets/d/ e /edit
const SHEET_ID = 'INSERISCI_QUI_ID_DEL_TUO_GOOGLE_SHEET';   // ← obbligatorio

// Nome del foglio (tab in basso) — lascia 'Main' o cambia se usi un altro nome
const SHEET_NAME = 'Main';

// ─── Configurazione email ─────────────────────────────────────
const NOME_COMUNE = 'NOME_DEL_COMUNE';   // ← es. 'Palermo'
const EMAIL_NOREPLY = '';                // ← es. 'noreply@comune.it' (opzionale)

// ─── Configurazione GitHub per upload immagini ───────────────
// Necessario solo se vuoi caricare le foto sul tuo repo GitHub.
// Imposta anche il token segreto nelle proprietà script:
//   Script → Impostazioni progetto → Proprietà script → aggiungi GITHUB_TOKEN
const GITHUB_OWNER  = 'TUO_USERNAME_GITHUB';   // ← es. 'mario-rossi'
const GITHUB_REPO   = 'NOME_REPO';             // ← es. 'Segnalazioni'
const GITHUB_BRANCH = 'master';                // ← branch principale (es. 'main' o 'master')
